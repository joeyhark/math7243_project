...
if __name__ == "__main__":
    ...
    # f_name = "bildstein_station1_xyz_intensity_rgb"
    # f_name1 = "D:\Mass Storage\School Work (Current Year)\Semester 4\Machine & Statistical learning\Project\Open3D-PointNet2-Semantic3D-master\dataset\semantic_raw\bildstein_station1_xyz_intensity_rgb.txt"
    # f_name2 = os.path.join(raw_dir, f_name + ".txt")
    # print(f_name2)
    # with open(f_name2, 'r') as file:
    #     print(file.read())
    #     exit()
