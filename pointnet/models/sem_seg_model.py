...
from pointnet.pnet2_layers.layers import Pointnet_SA, Pointnet_FP


class reduced2_SEM_SEG_Model(Model):

    def __init__(self, batch_size, num_classes, bn=False, activation=tf.nn.relu):
        super(reduced2_SEM_SEG_Model, self).__init__()
    ...
    def forward_pass(self, input, training):
        ...
        # print(3)
        l1_points = self.fp_1(l1_xyz, l2_xyz, l1_points, l2_points, training=training)
        # print(4)
        l0_points = self.fp_2(l0_xyz, l1_xyz, l0_points, l1_points, training=training)
...
class original_SEM_SEG_Model(Model):

    def __init__(self, batch_size, num_classes, bn=False, activation=tf.nn.relu):
        super(original_SEM_SEG_Model, self).__init__()
